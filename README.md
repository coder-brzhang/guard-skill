...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/your-org/guard-skill)
...
```bash
# 克隆项目
git clone https://github.com/your-org/guard-skill.git
...
- 🐛 [报告 Bug](https://github.com/your-org/guard-skill/issues)
- 🔒 [提交新的恶意模式](https://github.com/your-org/guard-skill/pulls) — 编辑 `skills/guard/scan-patterns.md` 和 `scripts/scan-skill.sh`
- 💡 [功能建议](https://github.com/your-org/guard-skill/issues)
